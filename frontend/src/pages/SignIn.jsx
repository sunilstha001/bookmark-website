    ...
    <div className="min-h-screen bg-gradient-to-br from-navy-50 to-navy-100 flex items-center justify-center p-3 sm:p-4">
      ...
      >
        ...
        <div className="text-center mb-4 sm:mb-6">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-navy-800 mb-1">Welcome to Markly</h1>
          <p className="text-xs sm:text-sm text-navy-500">Your beautiful bookmark manager</p>
        </div>

        {/* Clerk Sign-In Component with Custom Appearance - Smaller padding */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
